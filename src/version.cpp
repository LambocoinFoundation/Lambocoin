...
// for both Lambocoind and Lambocoin(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of Lambocoin releases, the client name should be selected from
