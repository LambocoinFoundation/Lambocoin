 ...
 * The Lambocoin Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("Lambocoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    setWindowIcon(QIcon(":icons/Lambocoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Lambocoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/Lambocoin"), tr("&About Lambocoin"), this);
    aboutAction->setToolTip(tr("Show information about Lambocoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Lambocoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/Lambocoin"), tr("Show/Hide &Lambocoin"), this);
    toggleHideAction->setToolTip(tr("Show or hide the Lambocoin window"));
    ...
    editConfigAction->setToolTip(tr("Edit the Lambocoin.conf file in the default text editor"));
...
#ifndef Q_OS_MAC
            setWindowIcon(QIcon(":icons/Lambocoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/Lambocoin_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Lambocoin client"));
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide Lambocoin"
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Lambocoin network", "", count));
}
