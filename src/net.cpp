...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Lambocoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
// testnet dns seed begins with 't', all else are Lambocoin dns seeds.
static const char *strDNSSeed[][2] = {
    {"dnsseed.Lambocoin.com", "dnsseed.Lambocoin.com"},
    {"dnsseed.Lambocoinfoundation.org", "dnsseed.Lambocoinfoundation.org"},
    {"dnsseed.xpydev.org", "dnsseed.xpydev.org"},
    {"tseed.Lambocoin.com", "tseed.Lambocoin.com"},
    {"testnet-seed.Lambocoin.mitchellcash.com", "testnet-seed.Lambocoin.mitchellcash.com"} // Mitchell Cash
};
...
unsigned int pnSeed[] =
{
    // Hard Code DNS Seed IPS for Lambocoin, Lambocoinfoundation, xpydev
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Lambocoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    // Lambocoin: mint proof-of-stake blocks in the background
