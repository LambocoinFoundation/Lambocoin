Lambocoin version 0.2.0.0 is now available from:
...
Lambocoin data directory (listed below) and delete everything except the
wallet.dat and Lambocoin.conf

Linux : ~/.Lambocoin/

Windows : %appdata%\Roaming\Lambocoin
...
- `62a3da1` Update GitHub URLs to point to LambocoinFoundation/Lambocoin
...
- `19ca0ef` Point GitHub URL to LambocoinFoundation
