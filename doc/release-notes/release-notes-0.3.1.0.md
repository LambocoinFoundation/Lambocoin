Lambocoin version 0.3.1.0 is now available from:
...
- `6a3e798` Lambocoin-Qt (Windows only): enable DEP for Lambocoin-qt.exe
...
Miscellaneous:
- `fb66d3f` remove pre-Lambocoin protocol versions
